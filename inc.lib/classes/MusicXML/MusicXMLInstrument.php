...
class MusicXMLInstrument
{
    ...
    const DRUM_SET = array(
        ...
        35 => array('Acoustic Bass Drum', '', 'drum.bass-drum'),
        36 => array('Bass Drum 1', '', 'drum.bass-drum'),
        37 => array('Side Stick', '', 'drum.side-stick'),
        38 => array('Acoustic Snare', '', 'drum.snare-drum'),
        39 => array('Hand Clap', '', 'effect.hand-clap'),
        40 => array('Electric Snare', '', 'drum.snare-drum.electric'),
        41 => array('Low Floor Tom', '', 'drum.tom-tom'),
        42 => array('Closed Hi-Hat', '', 'metal.hi-hat'),
        43 => array('High Floor Tom', '', 'drum.tom-tom'),
        44 => array('Pedal Hi-Hat', '', 'metal.hi-hat'),
        45 => array('Low Tom', '', 'drum.tom-tom'),
        46 => array('Open Hi-Hat', '', 'metal.hi-hat'),
        47 => array('Low Mid Tom', '', 'drum.tom-tom'),
        48 => array('High Mid Tom', '', 'drum.tom-tom'),
        49 => array('Crash Cymbal 1', '', 'metal.cymbal.crash'),
        50 => array('High Tom', '', 'drum.tom-tom'),
        51 => array('Ride Cymbal 1', '', 'metal.cymbal.ride'),
        52 => array('Chinese Cymbal', '', 'metal.cymbal.chinese'),
        53 => array('Ride Bell', '', 'metal.bells.cowbell'),
        54 => array('Tambourine', '', 'drum.tambourine'),
        55 => array('Splash Cymbal', '', 'metal.cymbal.splash'),
        56 => array('Cowbell', '', 'metal.bells.cowbell'),
        57 => array('Crash Cymbal 2', '', 'metal.cymbal.crash'),
        58 => array('Vibraslap', '', 'rattle.vibraslap'),
        59 => array('Ride Cymbal 2', '', 'metal.cymbal.ride'),
        60 => array('High Bongo', '', 'drum.bongo'),
        61 => array('Low Bongo', '', 'drum.bongo'),
        62 => array('Mute High Conga', '', 'drum.conga'),
        63 => array('Open High Conga', '', 'drum.conga'),
        64 => array('Low Conga', '', 'drum.conga'),
        65 => array('High Timbale', '', 'drum.timbale'),
        66 => array('Low Timbale', '', 'drum.timbale'),
        //35..66
        67 => array('High Agogo', '', 'metal.bells.agogo'),
        68 => array('Low Agogo', '', 'metal.bells.agogo'),
        69 => array('Cabasa', '', 'rattle.cabasa'),
        70 => array('Maracas', '', 'rattle.maraca'),
        71 => array('Short Whistle', '', 'effect.whistle'),
        72 => array('Long Whistle', '', 'effect.whistle'),
        73 => array('Short Guiro', '', 'wood.guiro'),
        74 => array('Long Guiro', '', 'wood.guiro'),
        75 => array('Claves', '', 'wood.claves'),
        76 => array('High Wood Block', '', 'wood.wood-block'),
        77 => array('Low Wood Block', '', 'wood.wood-block'),
        78 => array('Mute Cuica', '', 'drum.cuica'),
        79 => array('Open Cuica', '', 'drum.cuica'),
        80 => array('Mute Triangle', '', 'metal.triangle'),
        81 => array('Open Triangle', '', 'metal.triangle')
    );
